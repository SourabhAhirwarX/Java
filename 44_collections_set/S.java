/*
    checking objects on the basis of hashCode() condition...
    hashCode() method will be internally implemented.
*/
...
class A {
    public static void main(String[] args) {
        ...
        Student w = new Student("rohan", 11);
...
class Student {
    ...
    public boolean equals(Object obj) {
        ...
        if(obj instanceof Student) {
            ...
            // flag = this.name.equals(((Student)obj).name);
        }
        return flag;
    }
